...
def closestStar(coords):
    '''
    Return the closest star - idx and coords
    '''
    idx = np.argmin([np.linalg.norm(coords-x) for x in world.starCoords])
    return (idx, world.starCoords[idx])
